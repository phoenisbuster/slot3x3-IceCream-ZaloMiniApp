...
export declare class DataCaching {
     ...
     *
     */
    static setStorage(this: ZaloMiniProgramSDK, object: InputDataType.SetStorageDataType): Promise<{
     ...
     *
     */
    static getStorage(this: ZaloMiniProgramSDK, object: InputDataType.GetStorageDataType): Promise<{
        [key: string]: any;
    }>;
    /**
     ...
     * @param {string} object.key - The specified key in the local cache
     */
    static removeStorage(this: ZaloMiniProgramSDK, object: InputDataType.RemoveStorageDataType): Promise<{
        errorKeys: Array<string>;
    }>;
    /**

...
var ZMPRouter = function ZMPRouter2(props) {
  ...
  return import_react55.default.createElement(AnimationRouterContext.Provider, {
    value: contextValue
  }, import_react55.default.createElement(RouterComponent, {
    basename: basepath
  }, children2));
};
  ...
  var handleChangePickerValue = function handleChangePickerValue2(otp, name) {
    setPickerValue(function(prevState) {
      ...
      if (((_prevState$name = prevState[name]) == null ? void 0 : _prevState$name.value) !== otp.value) {
        var _objectSpread29;
        return _objectSpread21(_objectSpread21({}, prevState), {}, (_objectSpread29 = {}, _objectSpread29[name] = otp, _objectSpread29));
      }
      return prevState;
    });
  };

...
var Picker = function Picker(props) {
  ...
  var handleChangePickerValue = function handleChangePickerValue(otp, name) {
    setPickerValue(function (prevState) {
      ...
      if (((_prevState$name = prevState[name]) == null ? void 0 : _prevState$name.value) !== otp.value) {
        var _objectSpread2;

        return _objectSpread(_objectSpread({}, prevState), {}, (_objectSpread2 = {}, _objectSpread2[name] = otp, _objectSpread2));
      }
  ...
  }, [value, pickerValue]); // Merge classes

  var prefixCls = getPrefixCls("picker");
  var inputCls = classNames(prefixCls + "-input", inputClass); // Render the picker modal

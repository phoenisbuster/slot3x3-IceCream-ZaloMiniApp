...
var DatePicker = function DatePicker(props) {
  ...
  var _useState = (0, _react.useState)((0, _utils.createPickerColumns)(value || defaultValue || new Date(), {
    startDate: startDate,
    endDate: endDate,
  ...
  var updateData = function updateData(curDate, curMonth, curYear) {
    ...
    var _getDateRange = (0, _utils.getDateRange)(startDate, endDate),
        settingStartDatge = _getDateRange.startDate,

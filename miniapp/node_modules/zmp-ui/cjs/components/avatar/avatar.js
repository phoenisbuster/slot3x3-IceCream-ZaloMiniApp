...
var calculateAvatarColor = function calculateAvatarColor(name) {
  if (typeof name !== "string") {
    ...
    return _propsType.GradientVariants["GREEN-GREENLIGHT"];
  }
  ...
  var colorIndex = sum % Object.keys(_propsType.GradientVariants).length;
  ...
  switch (colorIndex) {
    ...
    case 2:
      return _propsType.GradientVariants["PURPLE-BLUE"];

    case 3:
      return _propsType.GradientVariants["SKYBLUE-GREEN"];

    default:
      return _propsType.GradientVariants["BLUE-BLUELIGHT"];
  }
};

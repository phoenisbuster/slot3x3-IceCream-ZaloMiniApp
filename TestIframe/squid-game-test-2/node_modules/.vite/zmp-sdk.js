...
// node_modules/zmp-sdk/dist/index.es.js
...
typedArrayTags[argsTag] = typedArrayTags[arrayTag] = typedArrayTags[arrayBufferTag] = typedArrayTags[boolTag] = typedArrayTags[dataViewTag] = typedArrayTags[dateTag] = typedArrayTags[errorTag] = typedArrayTags[funcTag] = typedArrayTags[mapTag$1] = typedArrayTags[numberTag$1] = typedArrayTags[objectTag] = typedArrayTags[regexpTag$1] = typedArrayTags[setTag$1] = typedArrayTags[stringTag$1] = typedArrayTags[weakMapTag] = false;
...
function assignValue(object, key, value) {
  ...
  if (!(hasOwnProperty.call(object, key) && eq_1(objValue, value)) || value === void 0 && !(key in object)) {
...
(function(NetworkType2) {
  ...
  NetworkType2["cellular"] = "cellular";
...
(function(ProfileType2) {
  ...
  ProfileType2[ProfileType2["oa"] = 0] = "oa";
  ProfileType2[ProfileType2["aliasOA"] = 2] = "aliasOA";
})(ProfileType || (ProfileType = {}));
var ChatType;
(function(ChatType2) {
  ChatType2[ChatType2["user"] = 1] = "user";
  ChatType2[ChatType2["oa"] = 0] = "oa";
})(ChatType || (ChatType = {}));
var PostFeedType;
(function(PostFeedType2) {
  PostFeedType2[PostFeedType2["image"] = 1] = "image";
  PostFeedType2[PostFeedType2["link"] = 4] = "link";
  PostFeedType2[PostFeedType2["profile"] = 5] = "profile";
})(PostFeedType || (PostFeedType = {}));
var ShareSheetType;
(function(ShareSheetType2) {
  ShareSheetType2[ShareSheetType2["image"] = 1] = "image";
  ShareSheetType2[ShareSheetType2["gif"] = 11] = "gif";
  ShareSheetType2[ShareSheetType2["video"] = 12] = "video";
  ShareSheetType2[ShareSheetType2["link"] = 4] = "link";
  ShareSheetType2[ShareSheetType2["oa"] = 5] = "oa";
  ShareSheetType2[ShareSheetType2["zmp"] = 20] = "zmp";
  ShareSheetType2[ShareSheetType2["multi_image"] = 21] = "multi_image";
})(ShareSheetType || (ShareSheetType = {}));
var OrientationType;
(function(OrientationType2) {
  OrientationType2[OrientationType2["auto"] = 1] = "auto";
  OrientationType2[OrientationType2["portrait"] = 2] = "portrait";
  OrientationType2[OrientationType2["landscape"] = 3] = "landscape";
})(OrientationType || (OrientationType = {}));
var VibrateType;
(function(VibrateType2) {
  VibrateType2[VibrateType2["oneShot"] = 0] = "oneShot";
})(VibrateType || (VibrateType = {}));
var Events;
(function(Events2) {
  Events2["AppPaused"] = "h5.event.paused";
  Events2["AppResumed"] = "h5.event.resumed";
  Events2["NetworkChanged"] = "h5.event.connection.changed";
  Events2["OnDataCallback"] = "h5.event.webview.result";
  Events2["OpenApp"] = "h5.event.open.mp";
  Events2["AppClose"] = "h5.event.action.close";
})(Events || (Events = {}));
var MediaPickerType;
(function(MediaPickerType2) {
  MediaPickerType2[MediaPickerType2["zcamera"] = 3] = "zcamera";
  MediaPickerType2[MediaPickerType2["zcamera_photo"] = 1] = "zcamera_photo";
  MediaPickerType2[MediaPickerType2["zcamera_video"] = 2] = "zcamera_video";
  MediaPickerType2[MediaPickerType2["zcamera_scan"] = 7] = "zcamera_scan";
  MediaPickerType2[MediaPickerType2["photo"] = 4] = "photo";
  MediaPickerType2[MediaPickerType2["video"] = 5] = "video";
  MediaPickerType2[MediaPickerType2["file"] = 6] = "file";
...
var readCookieByDomain = (name) => {
  return readCookie(getCurrHost() + name);
};
var readCookieByRootDomain = (name) => {
  return readCookie(getCurrHostRootZaloMe() + name);
};
var readCookieFallback = (name) => {
...
var KB = 1024 * Byte;
var MB = 1024 * KB;
var ZAPP_ID = window.zAppID;
var APP_ID = window.APP_ID;
var APP_CONFIG = window.APP_CONFIG || {};
var MINI_APP_LINK = "https://zalo.me/app/link/zapps";
var MINI_APP_INTERNAL_LINK = "https://h5.zdn.vn/zapps";
var COOKIE_NAME = {
...
var STORAGE_LIMIT = 5 * MB;
var NETWORK_TYPE = (isAndroid) => ({
  NONE: isAndroid ? -2 : 0,
  WIFI: isAndroid ? 0 : 1,
  "2G": isAndroid ? 2 : 2,
  "3G": isAndroid ? 15 : 2,
...
var ZALO_SUPPORT_STORAGE_VERSION = {
  android: 12100571,
  iOS: 400,
  wp: 0,
  unknown: 0
};
var ZALO_SUPPORT_SHARE_MULTI_IMAGE_VERSION = {
  android: 12100615,
  iOS: 460,
  wp: 0,
  unknown: 0
};
var ZALO_IOS_ACTIONS_SUPPORTED_BEFORE_VER_402 = [
...
var ACTION_LEFT_BUTTON_TYPE = {
  SHOW_BACK: 0,
  HIDE_BACK: 3,
  SHOW_HOME: 1,
  HIDE_HOME: 0
};
var SHOW_ACTION_BAR = 5;
var HIDE_ACTION_BAR = 6;
var PAYMENT_APIS = {
  CREATE_ORDER: "https://payment-mini.zalo.me/api/order/create",
...
var PAYMENT_H5_URL = "https://payment-mini.zalo.me";
var AppError = class {
...
var handleKnownExceptions = (error, api) => {
  error.api = api;
  return error.toJSON();
};
var handleUnknownExceptions = (error, api) => {
...
var errorHandler = (error, api) => error instanceof AppError ? handleKnownExceptions(error, api) : handleUnknownExceptions(error, api);
var apiResponse = {
...
var REGEXP_SPECIAL_UNICODE = new RegExp("[\\u0300-\\u036f]", "g");
var REGEXP_ACCENT_D = new RegExp("[\u0111|\u0110]", "g");
var REGEXP_SPACES = new RegExp("\\s", "g");
var debug = Debug("zmp:utils:common");
...
var calcLocalStorageSize = (storage, prefix) => {
...
var getMetaValue = (key) => {
  const metas = document.getElementsByTagName("meta");
  for (let i = 0; i < metas.length; i++) {
    if (metas[i].getAttribute("name") === key || metas[i].getAttribute("property") === key) {
...
var getZaloVersion = () => {
  ...
  const version2 = _agents[1];
  if (version2) {
    const versionNumber = version2.replace(" ", "").split("/")[1];
    return versionNumber || "";
  }
  return "";
};
var getPlatform = () => {
  let platform2 = checkPlatform();
  if (platform2.isWP)
...
var isArray = (type, argument) => Array.isArray(argument) && !argument.some((i) => {
  if (type === "url") {
    return !isValidUrl(i);
  } else
    return typeof i !== type;
});
var isType = (argument, type) => {
  const lowerCaseType = type.toLowerCase();
  const types = lowerCaseType.split(/[<>]/i);
  const isArrayType = types[0] === "array";
  if (lowerCaseType === "url" && isValidUrl(argument) || isArrayType && (lowerCaseType === "array" && Array.isArray(argument) || isArray(types[1], argument)) || !Array.isArray(argument) && typeof argument === type) {
    return true;
  }
  return false;
};
...
var isSupportNativeStorage = () => {
  try {
    const zaloVersion = Number(getZaloVersion());
    const platform2 = getPlatform();
    return zaloVersion >= ZALO_SUPPORT_STORAGE_VERSION[platform2];
  } catch (error) {
    return true;
  }
};
...
var checkIOSSupportAction = (action) => {
  var _a;
  ...
  if (Array.isArray(window.ignoreCheckSupport) && window.ignoreCheckSupport.length > 0 && window.ignoreCheckSupport.includes(action.name)) {
    return true;
  }
  return zaloIOSVersion >= actionVersionLive;
};
var getZMPShareInfo = (appID, accessToken, shareTitle, shareDescription, shareThumbnail, sharePath) => __awaiter(void 0, void 0, void 0, function* () {
...
var checkData = (types, option) => (data) => {
  const validType = Array.isArray(types) ? types.some((type) => isType(data, type)) : isType(data, types);
  if (!validType) {
    return {
      error: true,
      errorMessage: types
...
var getAppInfo = (appId, versionStatus, currentVersion) => __awaiter(void 0, void 0, void 0, function* () {
  const inputData = {
    appId,
    versionStatus
  };
...
var ZMPEEmitter = class extends eventemitter3 {
  constructor() {
    super();
...
var NavigationBar = class {
  ...
  static setNavigationBarLeftButton(type, confirmToExit) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let showHomeButton;
      if (_.isString(type)) {
        leftButtonType = type === "none" || type === "home" ? ACTION_LEFT_BUTTON_TYPE.HIDE_BACK : ACTION_LEFT_BUTTON_TYPE.SHOW_BACK;
        showHomeButton = type === "home" || type === "both" ? ACTION_LEFT_BUTTON_TYPE.SHOW_HOME : ACTION_LEFT_BUTTON_TYPE.HIDE_HOME;
      }
...
var Background = class {
  static setBackgroundColor(object) {
    return __awaiter(this, void 0, void 0, function* () {
      if (_.isString(object.backgroundColor) && object.backgroundColor.length > 0) {
        yield this.getJSBridge().callNative(ACTION.CHANGE_ACTIONBAR, {
...
var _Logger_logLevel;
var _Logger_friendly;
var _Logger_content;
var _Logger_metric;
var _Logger_internalLog;
var Log = class {
  constructor(object, severity, level, title2) {
    this.title = title2;
...
var Logger = class {
  constructor() {
    ...
    _Logger_internalLog.set(this, (level, object, title2) => {
      ...
      __classPrivateFieldSet(this, _Logger_content, __classPrivateFieldGet(this, _Logger_content, "f") + (typeof object !== "string" ? new Log(object, severity, level, title2).toString() : object), "f");
  ...
  warn(object, title2) {
    __classPrivateFieldGet(this, _Logger_internalLog, "f").call(this, 2, object, title2);
  }
  error(object, title2) {
    __classPrivateFieldGet(this, _Logger_internalLog, "f").call(this, 1, object, title2);
  }
  getMetrics() {
  ...
  static onNetworkStatusChange(callback) {
    return __awaiter(this, void 0, void 0, function* () {
      yield this.events.on(Events.NetworkChanged, (data) => {
        ...
        this.getNetworkType().then((resNetworkType) => {
          const res = {
  ...
  static startBeaconDiscovery(object) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      const data = {
        ...
        data: {
          scan_from_source: _.isString(object === null || object === void 0 ? void 0 : object.scanFromSource) ? object.scanFromSource : "",
          expire: _.isNumber(object === null || object === void 0 ? void 0 : object.expire) ? object.expire : 3e3,
          monitor_interval: _.isNumber(object === null || object === void 0 ? void 0 : object.monitorInterval) ? object.monitorInterval : 60,
          domain: _.isString(object === null || object === void 0 ? void 0 : object.domain) ? object.domain : "",
          scan_config: {
            scan_time: _.isNumber((_a = object === null || object === void 0 ? void 0 : object.scanConfig) === null || _a === void 0 ? void 0 : _a.scanTime) ? object.scanConfig.scanTime : 15e3,
            time_between_scan: _.isNumber((_b = object === null || object === void 0 ? void 0 : object.scanConfig) === null || _b === void 0 ? void 0 : _b.timeBetweenScan) ? object.scanConfig.timeBetweenScan : 1e4,
            beacon_timeout: _.isNumber((_c = object === null || object === void 0 ? void 0 : object.scanConfig) === null || _c === void 0 ? void 0 : _c.beaconTimeout) ? object.scanConfig.beaconTimeout : 3e4,
            delayCheckConnectedTimeout: _.isNumber((_d = object === null || object === void 0 ? void 0 : object.scanConfig) === null || _d === void 0 ? void 0 : _d.delayCheckConnectedTimeout) ? object.scanConfig.delayCheckConnectedTimeout : 5e3,
            beaconConnectedTimeout: _.isNumber((_e = object === null || object === void 0 ? void 0 : object.scanConfig) === null || _e === void 0 ? void 0 : _e.beaconConnectedTimeout) ? object.scanConfig.beaconConnectedTimeout : 6e5
          },
  ...
  static getBeacons(object) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const resData = yield this.getJSBridge().callNative(ACTION.SCAN_IBEACON, Object.assign({}, data), {
        ...
        Array.isArray(resData2) && resData2.forEach((element) => {
          const ibeacon = {
            uuid: element.uuid,
            major: element.major,
            minor: element.minor,
...
var _LocalResourceStorage_storage;
var _LocalResourceStorage_prefix;
var _LocalResourceStorage_resourceInfo;
var LocalResourceStorage = class {
  constructor(prefix) {
  ...
  getInfoSync() {
    ...
    return {
      currentSize: _.isNumber(currentSize) ? Number((currentSize / 1024).toFixed(2)) : 0,
...
WrapperFn.setWrapper = function(fn) {
  var type = arguments.length <= 1 || arguments[1] === void 0 ? "default" : arguments[1];
  wrappers[type] = fn;
};
var ERROR = {
  error: {
...
var _ZaloJSBridge_instances;
var _ZaloJSBridge_jumpRunning;
var _ZaloJSBridge_cookies;
var _ZaloJSBridge_actionRuntimeInfo;
var _ZaloJSBridge_jsCall;
var ZaloJSBridge = class extends eventemitter3 {
  constructor() {
    super();
    ...
    this.getCookie = (name) => __awaiter(this, void 0, void 0, function* () {
      var _a;
      yield this.jump();
      const cookie = (_a = __classPrivateFieldGet(this, _ZaloJSBridge_cookies, "f")) === null || _a === void 0 ? void 0 : _a.find((cookie2) => cookie2.name === name);
      return cookie;
    });
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve, reject) => {
        if (this.isJumped) {
          ...
          this.callNative(ACTION.JUMP_LOGIN, {}).then((data) => {
            ...
            if (jsToken) {
              ...
              window.ZJSBridge.setJSToken && window.ZJSBridge.setJSToken(jsToken.value);
            }
  ...
  sendLogData(data) {
    try {
      ...
      window.zmpSentry && window.zmpSentry.captureMessage("Result from native", {
        extra: {
          data
        }
      });
  ...
  onJSCall(key, data) {
    try {
      ...
      try {
        if (parsedData.action === ACTION.OPEN_INAPP.name || parsedData.action === ACTION.OPEN_OUTAPP.name) {
      ...
      const handleNativeCallback = (cb) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (cb.error_code !== 0) {
            ...
            } else if (String(error.message).toLowerCase() === "permission required!" || String(error.message).toLowerCase() === "no permission!") {
              error = new AppError(RESPONSE.FORBIDDEN.code, RESPONSE.FORBIDDEN.message);
            } else if (COMMON_NATIVE_ERROR_CODE[platform2][cb.error_code]) {
              error = new AppError(COMMON_NATIVE_ERROR_CODE[platform2][cb.error_code].code, COMMON_NATIVE_ERROR_CODE[platform2][cb.error_code].message);
            } else if ((_b = (_a = action.error_list) === null || _a === void 0 ? void 0 : _a[platform2]) === null || _b === void 0 ? void 0 : _b[String(cb.error_code)]) {
              let error_message = action.error_list[platform2][String(cb.error_code)].map_to.message;
              if ((_e = (_d = (_c = action.error_list) === null || _c === void 0 ? void 0 : _c[platform2]) === null || _d === void 0 ? void 0 : _d[String(cb.error_code)]) === null || _e === void 0 ? void 0 : _e.need_more_detail) {
                error_message = `${(_h = (_g = (_f = action.error_list) === null || _f === void 0 ? void 0 : _f[platform2]) === null || _g === void 0 ? void 0 : _g[String(cb.error_code)]) === null || _h === void 0 ? void 0 : _h.map_to.message}: ${cb.error_message}`;
              }
              error = new AppError(action.error_list[platform2][String(cb.error_code)].map_to.code, error_message);
            }
            return reject(error);
          }
...
_ZaloJSBridge_jumpRunning = new WeakMap(), _ZaloJSBridge_cookies = new WeakMap(), _ZaloJSBridge_actionRuntimeInfo = new WeakMap(), _ZaloJSBridge_instances = new WeakSet(), _ZaloJSBridge_jsCall = function _ZaloJSBridge_jsCall2(action, options, callback, isMultiCallback = false, nRetry = 3, haveTimeout = true) {
  try {
    ...
    this._jsCallFuncCallbacks[key] = {
      inputData: options,
      timeout: haveTimeout && action.have_callback && setTimeout(() => {
    ...
    try {
      ...
      if (nRetry-- > 0) {
        setTimeout(() => {
          __classPrivateFieldGet(this, _ZaloJSBridge_instances, "m", _ZaloJSBridge_jsCall2).call(this, action, options, callback, isMultiCallback, nRetry);
        }, 500);
      } else {
        const errorCallback = {
          error_code: -5,
...
var _NativeResourceStorage_appId;
var _NativeResourceStorage_resourceInfo;
var _NativeResourceStorage_bridge;
var NativeResourceStorage = class {
  constructor(appId) {
  ...
  get(keys) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield __classPrivateFieldGet(this, _NativeResourceStorage_bridge, "f").callNative(ACTION.ZBROWSER_MPDS, {
  ...
  set(data) {
    return __awaiter(this, void 0, void 0, function* () {
      const errorKeys = yield __classPrivateFieldGet(this, _NativeResourceStorage_bridge, "f").callNative(ACTION.ZBROWSER_MPDS, {
        ...
        let res = [];
        if (data2 && data2.mpds_data && data2.mpds_data.error_keys) {
          res = data2.mpds_data.error_keys;
        }
        return res;
      });
      return { errorKeys };
  ...
  getInfo() {
    return __awaiter(this, void 0, void 0, function* () {
      const currentSize = yield __classPrivateFieldGet(this, _NativeResourceStorage_bridge, "f").callNative(ACTION.ZBROWSER_MPDS, {
...
var _LocalStorageCreator_appId;
var _NativeStorageCreator_appId;
var StorageCreator = class {
...
var LocalStorageCreator = class extends StorageCreator {
  constructor(appId) {
    super();
...
var NativeStorageCreator = class extends StorageCreator {
  constructor(appId) {
    super();
  ...
  static getLocation(object) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield this.getJSBridge().callNative(ACTION.GET_LOCATION, {
        ...
        permission_description: "Cho ph\xE9p Zalo truy c\u1EADp v\xE0o v\u1ECB tr\xED c\u1EE7a thi\u1EBFt b\u1ECB n\xE0y?"
      }, {
        isMultiCallback: true,
        haveTimeout: false,
        successCallback: (data) => {
...
var Zalo = class {
  ...
  static openPostFeed(object) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield this.getJSBridge().callNative(ACTION.OPEN_POSTFEED, Object.assign(Object.assign({ type: PostFeedType[object.type] }, reqData), { zapp: this.getZAppId() })).then((res) => {
        return {
          status: res.status,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      switch (object.type) {
        case "image":
          ...
          const platform2 = getPlatform();
          if (zaloVersion >= ZALO_SUPPORT_SHARE_MULTI_IMAGE_VERSION[platform2]) {
            type = "multi_image";
          }
          if (Array.isArray(object.data.imageUrls) && object.data.imageUrls.length > 0) {
      ...
      return yield this.getJSBridge().callNative(ACTION.OPEN_SHARESHEET, Object.assign(Object.assign({ type: ShareSheetType[type] }, reqData), { zapp: this.getZAppId() }), {
        haveTimeout: false
      }).then((res) => {
        return {
          status: res.status,
  ...
  static createShortcut(url, title2, icon) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield this.getJSBridge().callNative(ACTION.GET_SUPPORTED_ACTIONS, {}, {
        ...
        successCallback: (data) => {
          ...
          if (Array.isArray(data.actions) && data.actions.length > 0) {
            ...
            return Promise.resolve(res);
          } else if (platform2 === PlatformType.iOS) {
            const res = {
...
var Routing = class {
  static getRouteParams() {
    ...
    try {
      ...
      throw new Error("Url kh\xF4ng h\u1EE3p l\u1EC7");
    }
    return result;
  }
...
var _ZaloMiniProgramSDKService_zAppId;
var _ZaloMiniProgramSDKService_appId;
var _ZaloMiniProgramSDKService_appConfig;
var _ZaloMiniProgramSDKService_zOAuth;
var _ZaloMiniProgramSDKService_zOAuthVrf;
var _ZaloMiniProgramSDKService_accessToken;
var _ZaloMiniProgramSDKService_refreshToken;
var _ZaloMiniProgramSDKService_cache;
var _ZaloMiniProgramSDKService_bridge;
var _ZaloMiniProgramSDKService_prevGetTokenTimestamp;
var _ZaloMiniProgramSDKService_tokenExpiresIn;
var _ZaloMiniProgramSDKService_deviceId;
var _ZaloMiniProgramSDKService_context;
var _ZaloMiniProgramSDKService_actionBarConfig;
var _ZaloMiniProgramSDKService_loginRunning;
var _ZaloMiniProgramSDKService_autoLogin;
var _ZaloMiniProgramSDKService_getActionsSupported;
var ZaloMiniProgramSDKService = class {
  constructor() {
    ...
    this.setAccessToken = (accessToken) => {
      ...
      window.ZJSBridge.setZAccSession && window.ZJSBridge.setZAccSession(accessToken);
    };
    ...
    __classPrivateFieldSet(this, _ZaloMiniProgramSDKService_autoLogin, false, "f");
    const showHomeButton = ((_b = (_a = __classPrivateFieldGet(this, _ZaloMiniProgramSDKService_appConfig, "f")) === null || _a === void 0 ? void 0 : _a.app) === null || _b === void 0 ? void 0 : _b.leftButton) === "home" || ((_d = (_c = __classPrivateFieldGet(this, _ZaloMiniProgramSDKService_appConfig, "f")) === null || _c === void 0 ? void 0 : _c.app) === null || _d === void 0 ? void 0 : _d.leftButton) === "both" ? ACTION_LEFT_BUTTON_TYPE.SHOW_HOME : ACTION_LEFT_BUTTON_TYPE.HIDE_HOME;
    const currentUrl = new URL(location.href);
    const actionBarType = _.isString((_f = (_e = __classPrivateFieldGet(this, _ZaloMiniProgramSDKService_appConfig, "f")) === null || _e === void 0 ? void 0 : _e.app) === null || _f === void 0 ? void 0 : _f.headerColor) && ((_j = (_h = (_g = __classPrivateFieldGet(this, _ZaloMiniProgramSDKService_appConfig, "f")) === null || _g === void 0 ? void 0 : _g.app) === null || _h === void 0 ? void 0 : _h.headerColor) === null || _j === void 0 ? void 0 : _j.length) > 0 ? SHOW_ACTION_BAR : HIDE_ACTION_BAR;
    const leftButtonType = ((_l = (_k = __classPrivateFieldGet(this, _ZaloMiniProgramSDKService_appConfig, "f")) === null || _k === void 0 ? void 0 : _k.app) === null || _l === void 0 ? void 0 : _l.leftButton) === "none" || ((_o = (_m = __classPrivateFieldGet(this, _ZaloMiniProgramSDKService_appConfig, "f")) === null || _m === void 0 ? void 0 : _m.app) === null || _o === void 0 ? void 0 : _o.leftButton) === "home" ? ACTION_LEFT_BUTTON_TYPE.HIDE_BACK : ACTION_LEFT_BUTTON_TYPE.SHOW_BACK;
    ...
    return __awaiter(this, void 0, void 0, function* () {
      return yield fetch(`${APIS.GET_ACCESS_TOKEN_V3}?app_id=${__classPrivateFieldGet(this, _ZaloMiniProgramSDKService_zAppId, "f")}&redirect_uri=${MINI_APP_INTERNAL_LINK}/${__classPrivateFieldGet(this, _ZaloMiniProgramSDKService_appId, "f")}/&code=${__classPrivateFieldGet(this, _ZaloMiniProgramSDKService_zOAuth, "f")}&isSDK=true`).then((response) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (resData.access_token) {
          ...
          const expiresIn = parseInt(resData.expires_in) * 1e3;
          ...
          window.ZJSBridge.setZAccSession && window.ZJSBridge.setZAccSession(__classPrivateFieldGet(this, _ZaloMiniProgramSDKService_accessToken, "f") || "");
          return __classPrivateFieldGet(this, _ZaloMiniProgramSDKService_accessToken, "f");
        }
        return null;
      }));
  ...
  loginZaloV4() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield fetch(APIS.GET_ACCESS_TOKEN, Object.assign({ method: "POST", body: inputData }, config2)).then((response) => __awaiter(this, void 0, void 0, function* () {
        const resData = yield response.json();
...
var _MockSDKService_appId;
var _MockSDKService_appConfig;
var _MockSDKService_zOAuth;
var _MockSDKService_accessToken;
var _MockSDKService_cache;
var _MockSDKService_loggedId;
var MockSDKService = class {
  constructor() {
...
(function(Reflect2) {
  (function(factory) {
    ...
    var _Map2 = !usePolyfill && typeof Map === "function" && typeof Map.prototype.entries === "function" ? Map : CreateMapPolyfill();
    var _Set2 = !usePolyfill && typeof Set === "function" && typeof Set.prototype.entries === "function" ? Set : CreateSetPolyfill();
    var _WeakMap2 = !usePolyfill && typeof WeakMap === "function" ? WeakMap : CreateWeakMapPolyfill();
    var Metadata = new _WeakMap2();
...
var checkTypeMetadataKey = Symbol("checkType");
var required = (fields, option) => (target, propertyKey, parameterIndex) => {
...
var checkType = (type, properties, defaultValue) => (target, propertyKey, parameterIndex) => {
...
var DecorateAll = (decorator, options = {}) => {
  return (target) => {
    var _a;
...
var centralizedFunctionHandler = (target, propertyName, descriptor) => {
        ...
        checkTypeParameters.forEach((parameter) => {
          ...
          if (!_.isUndefined(argument)) {
            if (!isType(argument, type)) {
              throw apiResponse.error.wrongTypeParam(argumentName, type, Array.isArray(argument) ? "array" : argument === null ? "null" : parameterType);
            }
            if (type === "object") {
              Object.entries(properties).forEach(([propKey, propType]) => {
                ...
                if (!_.isUndefined(propValue) && !_.isNull(propValue)) {
                  if (_.isFunction(propType)) {
                    const res2 = propType(propValue);
                    if (res2 && res2.error) {
                      throw apiResponse.error.wrongTypeParam(`${argumentName}.${key}`, res2.errorMessage, typeof propValue);
                    }
                  }
                } else if (!propKey.includes("?")) {
                  throw apiResponse.error.missingParam(propKey);
                } else if (!_.get(argument, key.split(".")[0]) && defaultValue && !_.isUndefined(_.get(defaultValue, key))) {
        ...
        requiredParameters.forEach((parameter) => {
          ...
          if (isMeetCondition) {
            fields.forEach((item) => {
              ...
              if (Array.isArray(item) && item.length > 0 && item.every(isInValidField)) {
...
var SDKCreator = class SDKCreator2 {
  constructor() {
    this.events = ZMPEEmitter.getInstance();
  ...
  createShortcut(object) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const title2 = appInfo.name || document.title;
      const searchParams = object.params ? new URLSearchParams(object.params) : new URLSearchParams();
      ...
      if (isIOS) {
        ...
        searchParams.append("appName", title2);
        ...
        yield __classPrivateFieldGet(this, _SDKCreator_sdkService, "f").createShortcut(`${MINI_APP_LINK}/${APP_ID}/?${searchParams.toString()}`, title2, iconURL);
      }
          ...
          if (resData.error === 0 && resData.data) {
            users = uIds.map((item) => {
              ...
              return {
                ...
                message: `Get profile: ${_.isUndefined((_k = resData.data[item]) === null || _k === void 0 ? void 0 : _k.message) ? "Unknown error" : (_l = resData.data[item]) === null || _l === void 0 ? void 0 : _l.message}`
              };
            });
          } else {
  ...
  requestUpdateZalo(object) {
    return __awaiter(this, void 0, void 0, function* () {
      const appStoreURL = checkPlatform().isIOS ? "https://apps.apple.com/vn/app/zalo/id579523206" : "https://play.google.com/store/apps/details?id=com.zing.zalo";
  ...
  onConfirmToExit(callback) {
    ...
    __classPrivateFieldGet(this, _SDKCreator_sdkService, "f").setNavigationBarLeftButton(void 0, 2);
  }
  offConfirmToExit() {
    this.events.off(Events.AppClose);
    __classPrivateFieldGet(this, _SDKCreator_sdkService, "f").setNavigationBarLeftButton(void 0, 0);
  }
  getDeviceId() {
...
__decorate([
  __param(0, checkType("object", {
    ...
    ui: {
      title: "X\xE1c th\u1EF1c",
      subTitle: "S\u1EED d\u1EE5ng sinh tr\u1EAFc h\u1ECDc c\u1EE7a b\u1EA1n \u0111\u1EC3 x\xE1c th\u1EF1c",
      negativeButtonText: "\u0110\xF3ng"
    }
  }))
...
var ZaloMiniAppSDKCreator = class extends SDKCreator {
  getServiceInstance() {
    return ZaloMiniProgramSDKService.getInstance();
  }
};
var MockSDKCreator = class extends SDKCreator {
  getServiceInstance() {
  ...
  createOrder(sdk, object) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const version2 = window.APP_VERSION;
        const env2 = window.APP_ENV;
        const params = {
          miniAppId,
          orderId
        };
...
var _PaymentCreator_instance;
var _PaymentCreator_sdk;
var PaymentCreator = class PaymentCreator2 {
  constructor(sdk) {
...
var ZaloMiniAppPaymentCreator = class extends PaymentCreator {
  getInstance() {
    return PaymentService.getInstance();
  }
};
var MockZaloMiniAppPaymentCreator = class extends PaymentCreator {
  getInstance() {
...
if (platform.isZalo) {
  ...
  payment = new ZaloMiniAppPaymentCreator(app);
} else {
  app = new MockSDKCreator();
  payment = new MockZaloMiniAppPaymentCreator(app);
}
window.ZaloMiniAppSDK = app;
var index_es_default = app;

// dep:zmp-sdk
var zmp_sdk_default = index_es_default;
export {
  ChatType,
  Events,
  MediaPickerType,

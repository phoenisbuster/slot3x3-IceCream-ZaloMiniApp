  ...
  var handleChange = function handleChange2(_ref) {
    ...
    if (!Array.isArray(value)) {
      ...
      if (thumbIndex.current === 0) {
        var endValue = clamp3(end - nextValue < minRange ? nextValue + step : end, min, max);
        ...
        var startValue = clamp3(nextValue - start2 < minRange ? nextValue - step : start2, min, max);
    ...
    frame.current = requestAnimationFrame(function() {
      if (trackRef.current) {
        ...
        if (rect.width && rect.height) {
          var tempX = clamp3((x - rect.left) / rect.width, 0, 1);
          if (checkNearest) {
            if (Array.isArray(value)) {
              var start2 = value[0], end = value[1];

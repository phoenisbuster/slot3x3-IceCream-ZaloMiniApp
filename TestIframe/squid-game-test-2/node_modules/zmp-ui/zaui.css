...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url("https://h5.zdn.vn/static/fonts/ZMPIcons-Regular-v3.woff2");
  src: url("https://h5.zdn.vn/static/fonts/ZMPIcons-Regular-v3.woff2") format("woff2"), url("https://h5.zdn.vn/static/fonts/ZMPIcons-Regular-v3.woff") format("woff"), url("https://h5.zdn.vn/static/fonts/ZMPIcons-Regular-v3.ttf") format("truetype");
}
.zaui-icon {
...
.zaui-input-affix-wrapper:hover.zaui-input-status-error,
.zaui-input-affix-wrapper:focus.zaui-input-status-error,
.zaui-input-affix-wrapper:focus-visible.zaui-input-status-error {
  border-color: #dc1f18;
}
.zaui-input-textarea {
  resize: none;
...
.zaui-input-otp-cursor::after {
  ...
  background: #006af5;
  height: 32px;
  -webkit-animation: cursorAnimate 0.9s infinite;
...
body[zaui-theme="dark"] .zaui-input:hover.zaui-input-status-error,
body[zaui-theme="dark"] .zaui-input:focus.zaui-input-status-error,
body[zaui-theme="dark"] .zaui-input:focus-visible.zaui-input-status-error {
  border-color: #dc1f18;
}

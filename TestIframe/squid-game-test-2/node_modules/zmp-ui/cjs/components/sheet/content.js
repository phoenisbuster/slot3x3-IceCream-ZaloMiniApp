...
var Content = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var animationConfig = _objectSpread(_objectSpread({}, _web.config.stiff), {}, {
    duration: !visible || !sheetSnapPoints || currentSnapPoint === sheetSnapPoints.length - 1 ? _constants.ANIMATION_DURATION : undefined,
    velocity: vy
  });
  ...
  var transform = (0, _web.to)([transformAmount, slideAmount], function (amount, slide) {

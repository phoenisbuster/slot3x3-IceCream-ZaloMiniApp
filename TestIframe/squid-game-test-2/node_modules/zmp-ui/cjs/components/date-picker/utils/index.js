...
exports.yearFormatter = exports.twoDigits = exports.shortMonthFormatter = exports.monthFormatter = exports.getPosition = exports.getPickerValues = exports.getMonthlyDay = exports.getDateRange = exports.formatDate = exports.dayFormatter = exports.createPickerColumns = exports.convertDateToPickerValue = void 0;
...
var getPickerValues = function getPickerValues(date, data) {
  var values = {};
  ...
  data.forEach(function (col) {
    switch (col.name) {
      case "YYYY":
        values[col.name] = year;
        break;

      case "MM":
        values[col.name] = month;
        break;
...
exports.getPickerValues = getPickerValues;
